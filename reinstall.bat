...
set confhome=https://raw.githubusercontent.com/rizxddev/reinstall/main
set confhome_cn=https://cnb.cool/rizxddev/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/rizxddev/reinstall/main
